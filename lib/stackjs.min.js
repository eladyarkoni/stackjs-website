...
render:function(){return this.element}});Class("Viewport::View",{width:typeof window!=="undefined"?window.innerWidth:0,height:typeof window!=="undefined"?window.innerHeight:0,init:function(delegate){this.delegate=delegate;this.element=document.body;this.start()},start:function(){var _self=this;if(document.addEventListener){window.addEventListener("load",function(){_self.callDelegate("didBecomeActive",[_self])},false);window.addEventListener("beforeunload",function(){_self.callDelegate("willResignActive",
